                     ...
                     <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title mb-3">Detail Peminjaman</strong> <a href="{{route('Operator.Peminjaman.index')}}" class="btn btn-secondary pull-right">Kembali</a>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <label class="control-label" for="inputTooltip">Lama Peminjaman : </label>
                                         @if($data->status_peminjaman)
                                            @if($data->tanggal_kembali)
                                                <span class="badge badge-warning">{{ countdate($data->tanggal_pinjam,$data->tanggal_kembali) }} Menit</span>
                                            @else
                                            <span class="badge badge-succsess">
                                                {{ countdate($data->tanggal_pinjam,date('Y-m-d H:i:s')) }} Menit
                                            </span>
                                            @endif
                                        @else
                                            -
