                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Data Pengembalian</strong> <a href="{{route('Operator.Peminjaman.index')}}"" type="button" class="btn btn-primary mb-1 pull-right"> <i class="fa fa-magic"></i>&nbsp; Input Peminjaman</a></button>
                            </div>
                                <div class="card-body">
                                    @if(count($data))
												...
												@foreach($data as $key => $val)
													<tr class="gradeA">
														...
														@if($val->status_peminjaman == 3 || $val->status_peminjaman == 1)
															<a href="{{ route('Operator.Pengembalian.kembali',[$val->id]) }}" class="btn btn-success">
																<i class="fa fa-check"></i>
																kembalikan Barang
															</a>
															@endif

															<a href="{{ route('Operator.Pengembalian.view',[$val->id]) }}" class="btn btn-primary">Detail</a>
														</td>
													</tr>
												@endforeach
											@else
