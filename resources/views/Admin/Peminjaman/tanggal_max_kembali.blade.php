                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-bordered" method="post" action="{{ route('Admin.Peminjaman.approve',[$id]) }}">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="inputTooltip">Maksimal Tanggal Kembali</label>
                                                <div class="col-md-6">
                                                     <input type="date" min="{{ date('Y-m-d') }}" name="max_kembali" required="" class="form-control">
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <footer class="panel-footer">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6" align="right">
                                                ...
                                                <a href="{{ route('Admin.Peminjaman.index') }}" class="btn btn-default">Kembali</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
