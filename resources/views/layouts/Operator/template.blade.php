            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title"></h3>
                     <li>
                        <a href="{{route('Operator.Peminjaman.index')}}"> <i class="menu-icon fa fa-dashboard"></i>peminjaman </a>
                        <a href="{{route('Operator.Pengembalian.index')}}"> <i class="menu-icon fa fa-dashboard"></i>Pengembalian </a>
                    </li>
